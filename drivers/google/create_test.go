...
func TestCreate(t *testing.T) {
	...
	if want, got := instance.Image, "ubuntu-os-cloud/global/images/ubuntu-2004-focal-v20201111"; got != want {
	...
	Disks: []*compute.AttachedDisk{
		{
			...
			InitializeParams: &compute.AttachedDiskInitializeParams{
				SourceImage: "https://www.googleapis.com/compute/v1/projects/ubuntu-os-cloud/global/images/ubuntu-2004-focal-v20201111",
